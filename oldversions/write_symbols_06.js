...
//	newHeight: data[1],
	...
	newHeight: textItems[0].range.characters[0].characterStyle.fontSize,
	...
	size: 14,
	color: 'black',
	rootPoint: new Point(textItems[0].bounds.x - textItems[0].bounds.width - 100, textItems[0].bounds.y),
...
// Define the palette components to edit each value:
    var components = {
		...
		onSelect: function() {
			...
			} else {components.trans_symbols.visible = true;
...
//	},
    ...
    print("components" + components.values)
